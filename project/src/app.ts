...
function fetchCountryInfo(
  countryName: string,
  status: CovidStatus,
): Promise<AxiosResponse<CovidCountryResponse>> {
...
function setDeathsList(data: CovidCountryResponse) {
...
function setTotalDeathsByCountry(data: CovidCountryResponse) {
  deathsTotal.innerText = data[0].Cases.toString();
}

function setRecoveredList(data: CovidCountryResponse) {
  const sorted = data.sort(
    (a: CountryInfo, b: CountryInfo) =>
      getUnixTimestamp(b.Date) - getUnixTimestamp(a.Date),
  );
...
function setTotalRecoveredByCountry(data: CovidCountryResponse) {
...
function setChartData(data: CovidCountryResponse) {
